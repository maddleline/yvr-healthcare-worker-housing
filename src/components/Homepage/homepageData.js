  ...
  English: {
    ...
    paragraphs: [
      ...
      <p key="english-2">
        ...
        for low-cost accommodation where she could safely distance from her
        family. Within 24 hours, she received over 75 offers.
      </p>,
    ],
    ...
    paragraphs: [
      ...
      <p key="french-2">
        ...
        <a
          ...
          rel="noopener noreferrer"
        >
          infirmière qui demandait de l’aide
        </a>{" "}
        pour un logement bon marché. Elle voulait se distancier en toute
        sécurité de sa famille, et en moins de 24 heures, elle a reçu plus de 75
        offres.
      </p>,
    ],
